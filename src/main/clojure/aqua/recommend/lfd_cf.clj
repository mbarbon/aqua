...
(defn get-raw-anime-recommendations [user lfd-users remove-known-anime]
...
(defn get-anime-recommendations [user lfd-users remove-known-anime keep-airing-anime tagger]
  (let [[similar-users recommended-completed] (get-raw-anime-recommendations user lfd-users remove-known-anime)
